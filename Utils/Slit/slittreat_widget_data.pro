...
if global['byte_list'] eq !NULL || (n_elements(mode) gt 0 && (mode eq 'MAKESELECT' || global['drawmode'] ne mode)) then begin
    ...
    global['byte_list'] = dblarr(picsize[0], picsize[1], sz[3])
    case mode of
        'ACTSIZE': begin
...
tvplot, global['byte_list', *, *, p], x_arg, y_arg, xrange = xrange, yrange = yrange, xmargin = global['xmargimg'], ymargin = global['ymargimg'], xtitle = 'arcsec', ytitle = 'arcsec', scale = 0
