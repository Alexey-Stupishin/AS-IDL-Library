function asu_dyn_smooth_down, scan, smoo, half_slit_vert, half_slit_horz, lim_top, lim_edge
...
if n_elements(downs) eq 0 then return, smoo
...
return, asu_dyn_smooth(smoo_down, half_slit_vert, half_slit_horz) 
