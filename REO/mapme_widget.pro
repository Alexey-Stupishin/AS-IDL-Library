            ...
            panes = WIDGET_BASE(mag_field, /row)
                pane1 = WIDGET_BASE(panes, /column)
                    ...
                    ctrlrow = WIDGET_BASE(pane1, /row)
                        ...
                        sinfocol = WIDGET_BASE(ctrlrow, /column, XSIZE = 150)
                        ...
                        ctrlcol = WIDGET_BASE(ctrlrow, /column, XSIZE = 150)
                            scale_base = WIDGET_BASE(ctrlcol, /row, /Nonexclusive, /align_right)
                                scale = WIDGET_BUTTON(scale_base, VALUE = 'Ind. Scale', UNAME = 'IND_SCALE', UVALUE = 'IND_SCALE', event_pro = 'mapme_widget_event_scale', XSIZE = 100)
                pane2 = WIDGET_BASE(panes, /column)
                    show_mask = WIDGET_DRAW(pane2, GRAPHICS_LEVEL = 0, UVALUE = 'MASK', UNAME = 'MASK', XSIZE = winsize[0], YSIZE = winsize[1])
                    legrow = WIDGET_BASE(pane2, /row, XSIZE = winsize[0])
