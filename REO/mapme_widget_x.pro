...
resolve_routine,'mapme_widget_event',/compile_full_file, /either
resolve_routine,'mapme_widget_update_mf',/compile_full_file, /either
resolve_routine,'mapme_widget_switch_view',/compile_full_file, /either
...
;        sdo = widget_base(tabs,/column, title = 'SDO/HMI')
...
;                    sdohmi_field = WIDGET_DRAW(pane1, GRAPHICS_LEVEL = 0, UNAME = 'SDOHMIFIELD', UVALUE = 'SDOHMIFIELD', XSIZE = winsize[0], YSIZE = winsize[1], /BUTTON_EVENTS)
...
;                    sdohmi_cont = WIDGET_DRAW(pane2, GRAPHICS_LEVEL = 0, UNAME = 'SDOHMICONT', UVALUE = 'SDOHMICONT', XSIZE = winsize[0], YSIZE = winsize[1], /BUTTON_EVENTS)
...
;                        show_mask = WIDGET_BUTTON(show_mask_base, VALUE = 'Show as Mask', UNAME = 'SHOWMASK', UVALUE = 'SHOWMASK', XSIZE = 100)
        ...
        mag_field = WIDGET_BASE(tabs,/column, title = 'Magnetic Field', UVALUE = 'TAB_MAGFIELD', UNAME = 'TAB_MAGFIELD')
            global['tabs_id', tab_id] = 'TAB_MAGFIELD'
            tab_id++
            ...
            panes = WIDGET_BASE(mag_field, /row)
                pane1 = WIDGET_BASE(panes, /column)
                    show_B = WIDGET_DRAW(pane1, GRAPHICS_LEVEL = 0, UVALUE = 'FIELD', UNAME = 'FIELD', XSIZE = winsize[0], YSIZE = winsize[1])
                    ctrlrow = WIDGET_BASE(pane1, /row)
                ...
                pane2 = WIDGET_BASE(panes, /column)
                    show_mask = WIDGET_DRAW(pane2, GRAPHICS_LEVEL = 0, UVALUE = 'MASK', UNAME = 'MASK', XSIZE = winsize[0], YSIZE = winsize[1])
                    legrow = WIDGET_BASE(pane2, /row)
                        ...
                        col2 = WIDGET_BASE(legrow, /column)
                            show_mask_base = WIDGET_BASE(col2, /column, /Nonexclusive, /ALIGN_RIGHT)
        ...
        atmo = widget_base(tabs,/column, title = 'Atmosphere', UVALUE = 'TAB_ATMO', UNAME = 'TAB_ATMO')
            global['tabs_id', tab_id] = 'TAB_ATMO'
            tab_id++
                    ...
                    edit_group = WIDGET_BASE(pane1, /row)
                        ...
                        zones_w_title = WIDGET_BASE(edit_group, /column)
                            ...
                            zones = WIDGET_BASE(zones_w_title, /column, /Nonexclusive, event_pro = 'mapme_widget_switch_zone')
                                zone1 = WIDGET_BUTTON(zones, VALUE = 'QS inter-network', UNAME = 'ZONE1', UVALUE = 'ZONE1', XSIZE = 110)
                                zone2 = WIDGET_BUTTON(zones, VALUE = 'QS network lane', UNAME = 'ZONE2', UVALUE = 'ZONE2', XSIZE = 110)
                                zone3 = WIDGET_BUTTON(zones, VALUE = 'Enhanced network', UNAME = 'ZONE3', UVALUE = 'ZONE3', XSIZE = 110)
                    ...
                    row_temp = WIDGET_BASE(pane2, /row)
                        ...
                        ctrl_temp = WIDGET_BASE(row_temp, /column)
                            ...
                            row_h_range = WIDGET_BASE(ctrl_temp, /row)
                                fromhr = WIDGET_TEXT(row_h_range, UNAME = 'FROMHR', VALUE = string(global['h_range', 0], format = '(%"%6.2f")'), XSIZE = 12, YSIZE = 1, /FRAME, /EDITABLE)
                                tohr = WIDGET_TEXT(row_h_range, UNAME = 'TOHR', VALUE = string(global['h_range', 1], format = '(%"%6.2f")'), XSIZE = 12, YSIZE = 1, /FRAME, /EDITABLE)
                            ...
                            row_t_range = WIDGET_BASE(ctrl_temp, /row)
                                fromtr = WIDGET_TEXT(row_t_range, UNAME = 'FROMTR', VALUE = string(global['temp_range', 0], format = '(%"%9.2e")'), XSIZE = 12, YSIZE = 1, /FRAME, /EDITABLE)
                                totr = WIDGET_TEXT(row_t_range, UNAME = 'TOTR', VALUE = string(global['temp_range', 1], format = '(%"%9.2e")'), XSIZE = 12, YSIZE = 1, /FRAME, /EDITABLE)
                            ...
                            row_t_sel = WIDGET_BASE(ctrl_temp, /row)
                                selh = WIDGET_TEXT(row_t_sel, UNAME = 'SELH', VALUE = '', XSIZE = 12, YSIZE = 1, /FRAME, /EDITABLE)
                                selt = WIDGET_TEXT(row_t_sel, UNAME = 'SELT', VALUE = '', XSIZE = 12, YSIZE = 1, /FRAME, /EDITABLE)
                    ...
                    row_dens = WIDGET_BASE(pane2, /row)
                        ...
                        ctrl_dens = WIDGET_BASE(row_dens, /column)
                            ...
                            row_d_range = WIDGET_BASE(ctrl_dens, /row)
                                fromdr = WIDGET_TEXT(row_d_range, UNAME = 'FROMDR', VALUE = string(global['dens_range', 0], format = '(%"%9.2e")'), XSIZE = 12, YSIZE = 1, /FRAME, /EDITABLE)
                                todr = WIDGET_TEXT(row_d_range, UNAME = 'TODR', VALUE = string(global['dens_range', 1], format = '(%"%9.2e")'), XSIZE = 12, YSIZE = 1, /FRAME, /EDITABLE)
                            ...
                            row_d_sel = WIDGET_BASE(ctrl_dens, /row)
                                selhd = WIDGET_TEXT(row_d_sel, UNAME = 'SELHD', VALUE = '', XSIZE = 12, YSIZE = 1, /FRAME, /EDITABLE)
                                seld = WIDGET_TEXT(row_d_sel, UNAME = 'SELD', VALUE = '', XSIZE = 12, YSIZE = 1, /FRAME, /EDITABLE)
        ...
        calc_res = widget_base(tabs,/column, title = 'Calculate', UVALUE = 'TAB_RESULT', UNAME = 'TAB_RESULT')
            global['tabs_id', tab_id] = 'TAB_RESULT'
            tab_id++
            panes = WIDGET_BASE(calc_res, /row)
                pane1 = WIDGET_BASE(panes, /column)
                    selfr = WIDGET_BASE(pane1, /row)
                        sel_mode = WIDGET_BASE(selfr, /column, /Exclusive)
                        ...
                        sel_data = WIDGET_BASE(selfr, /column)
                            fr_range_data = WIDGET_TEXT(sel_data, UNAME = 'FR_RANGE_DATA', VALUE = '4, 18, 0.5', XSIZE = 12, YSIZE = 1, /FRAME, /EDITABLE)
                            fr_range_list = WIDGET_TEXT(sel_data, UNAME = 'FR_LIST_DATA', VALUE = '', XSIZE = 12, YSIZE = 1, /FRAME, /EDITABLE)

                     fr_import = WIDGET_BUTTON(pane1, VALUE = 'Import...', UVALUE = 'FR_IMPORT', event_pro = 'mapme_widget_freq_import', SCR_XSIZE = 50)
