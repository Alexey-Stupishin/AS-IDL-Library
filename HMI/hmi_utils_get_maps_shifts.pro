pro hmi_utils_get_maps_shifts, fits1, fits2, xrange, yrange, shifts_corr, shifts_rot, verbose = verbose, latitude = latitude, longitude = longitude

read_sdo, fits1, ind1, data1
read_sdo, fits2, ind2, data2
