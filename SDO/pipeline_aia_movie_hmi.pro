pro l_pipeline_aia_movie_hmi_scale, x, y, ind, xstep, xshift, ystep, yshift
...
pro pipeline_aia_movie_hmi, work_dir, obj_dir, vis_data_dir, cadence, hmi_dir_wave_sel, hmi_vis_data_dir_wave, config, fps = fps
...
pipeline_aia_get_input_files, config, work_dir + path_sep() + hmi_dir_wave_sel, files_in
...
l_pipeline_aia_movie_hmi_scale, 0, 0, ind_seq[0], xstep, xshift, ystep, yshift
