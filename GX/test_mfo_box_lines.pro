...
aia_fits_file = 'G:/Samples/aia.lev1_euv_12s_mod.2011-10-10T085813Z.3.image.fits'   
hmi_file = 'G:/Samples/11312_hmi.M_720s.20111010_085818.W116N26CR.CEA.NAS.sav';
...
;----------------------------------------------
t0 = systime(/seconds)
nLines = asu_gxbox_calc_lines(box, inputSeeds, line_res, lib_location = lib_location)
