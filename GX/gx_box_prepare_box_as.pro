...
pro gx_box_prepare_box_as, time, centre, size_pix, dx_km, out_dir = out_dir, tmp_dir = tmp_dir,$
                  ...
                  box = box, pbox = pbox, hmi_files = hmi_files, magnetogram = magnetogram, full_Bz = full_Bz, no_hmi_prep = no_hmi_prep
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  box = gx_box_create_as(files.field, files.inclination, files.azimuth,files.disambig,$
     files.continuum, centre, size_pix, dx_km,top = top, cea = cea, carrington = carrington, sfq = sfq, no_hmi_prep = no_hmi_prep)
